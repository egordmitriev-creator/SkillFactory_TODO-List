...
//  TODO-List
//
//  Created by Егор Дмитриев on 23.01.2024.
//
...
extension TaskListTVC: TaskCompletedDelegate {
    func taskCompleted(task: TaskModel) {
        guard let taskByIndex = task.currentIndex?.item else { return }
        arrayUserTasks[taskByIndex].taskCellColor = #colorLiteral(red: 0.9472722411, green: 0.726231277, blue: 0.5750126839, alpha: 1)
        tableView.reloadData()
    }
}
